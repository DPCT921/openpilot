...
class LongitudinalMpc:
  ...
  def update(self, carstate, radarstate, v_cruise, x, v, a, j, prev_accel_constraint, desired_tf=T_FOLLOW, desired_stop_distance = STOP_DISTANCE):
    v_ego = self.x0[1]
    ...
    self.desired_stop_distance = desired_stop_distance
